...
/*Dar 3 variables, asignar 3 variables 
guardar las cuentas en 3 papeles
inicializar 
si el primero es mayor que el segundo dar datos
si el segundo es mayor al tercero dar un swap
otro for, el arreglo actual es mayor al primero si no preguntar si es mayor al segundo si no al tercero
*/
...
/*DOCUMENTACION #5
tiene lo mismo de lo anterior, solo que es tipo double
para generar los numeros forzar al numero entero 
rand()%501  
RAND_MAX     Busca los valores maximos de un double    
double((rand) / RAND_MAX* 1000.0);    //CASTING
*/
...
/*DOCUMENTACION #6
srand(time(null))  forzar a una variable 
/*
